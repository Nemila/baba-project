...
- [ ] Authentication/Authorization: Secure authentication system for users to create an account and log in. - [x] Options for sign-up via email, phone, or social media accounts.
...
- [x] Detailed Profiles: Each specialist's profile should include qualifications, years of practice, specialties, reviews, languages spoken, and a photo.
...
- [x] Appointment Types: Options for different types of appointments (e.g., in-person, teleconsultation).
- [x] Reminders and notification: Automated reminders for upcoming appointments sent via email or SMS. Notifications for any changes in the appointment.
...
- [x] Reminders: Send email to all users
- [ ] Cron Job: Setup up daily cron job for emails
...
- [x] SpecialistCard - Display specialist information in cards
- [x] AppointmentCard - Show brief details of appointments
